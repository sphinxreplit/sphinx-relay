...
function loadProxyCredentials(macPrefix) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            logger_1.sphinxLogger.warning(e);
            while (lndCert === undefined) {
                logger_1.sphinxLogger.warning('proxy tls cert not found retrying');
                yield (0, helpers_1.sleep)(60);
                lndCert = fs.readFileSync(config.proxy_tls_location);
            }
        }
...
function loadProxyLightning(ownerPubkey) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let credentials = yield loadProxyCredentials(macname);
